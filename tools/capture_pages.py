...
PAGES = [
    ...
    ("ja-foods", "/ja/foods?sort=kcal_desc", "Food database (browse)",
    ...
    ("ja-category", "/ja/category/肉類", "Category page — 肉類 (Meats)",
    ...
    ("ja-food", "/ja/food/こむぎ-うどん-ゆで", "Food page — udon, boiled",
    ...
    ("ja-food-prep", "/ja/food/こむぎ-うどん-ゆで", "Food page — preparation & FAQ",
    ...
    ("ja-guide", "/ja/guides/cooking-and-calories", "Guide — what cooking does to calories",
    ...
    ("ja-dish", "/ja/dish/あいまぜ", "Dish page — あいまぜ (Ishikawa)",
    ...
    ("ja-search", "/ja/search?q=みそ", "Search results",
    ...
    ("ja-meal", "/ja/meal-calculator", "Meal calculator",
     ...
     "MEAL_DEMO"),
    ("ja-goals", "/ja/goals", "Calorie goal calculator",
    ...
    ("ja-analyzer", "/ja/analyzer", "AI meal analyzer",
    ...
    ("ja-sources", "/ja/sources", "Data sources & licences",
